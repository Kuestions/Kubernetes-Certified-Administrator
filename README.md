...
* [Understand the Kubernetes API primitives](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.10/)
...
* [Good Overview of Ingress vs Services](http://blog.infracloud.io/deep-dive-ingress-kubernetes/)
